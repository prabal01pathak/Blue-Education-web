# Generated by Django 3.2.9 on 2021-11-29 10:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tests', '0014_studentdata_feedback'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='title',
            name='exam_type',
            field=models.CharField(blank=True, choices=[('JEE Mains', 'JEE Mains'), ('NEET', 'NEET'), ('PAT', 'PAT'), ('GATE', 'GATE'), ('Computer Science', 'Computer Science'), ('Business', 'Business')], default='Jee', max_length=100),
        ),
